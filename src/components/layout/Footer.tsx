...
export function Footer() {
    const companyName = "Vaishnavi Organics";
        ...
        <footer className="bg-[#2C1810] text-[#E8E4C9] pt-8 pb-6 md:pt-16 border-t-4 border-[#DAA520]">
            <Container>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-x-6 md:gap-y-10 mb-6 md:mb-12">
                    ...
                    <div className="space-y-4 md:space-y-6 text-center md:text-left">
                        <div className="flex items-center justify-center md:justify-start gap-2">
                            <span className="text-xl md:text-2xl font-bold text-[#B8860B]" style={{ fontFamily: 'var(--font-arista)', letterSpacing: '-0.02em' }}>{companyName}</span>
                        </div>
                    ...
                    <div className="border-b border-[#6F4E37]/30 md:border-none pb-2 md:pb-0">
                        ...
                        >
                            <h3 className="font-bold text-base md:text-lg text-[#B8860B]" style={{ fontFamily: 'var(--font-arista)', letterSpacing: '-0.02em' }}>Shop</h3>
                    ...
                    <div className="border-b border-[#6F4E37]/30 md:border-none pb-2 md:pb-0">
                        <button
                            ...
                            className="flex items-center justify-between w-full md:cursor-default py-1 md:py-0"
                        >
                            <h3 className="font-bold text-base md:text-lg text-[#B8860B]" style={{ fontFamily: 'var(--font-arista)', letterSpacing: '-0.02em' }}>Help & Policies</h3>
                    ...
                    <div className="border-b border-[#6F4E37]/30 md:border-none pb-2 md:pb-0">
                        <button
                            ...
                            className="flex items-center justify-between w-full md:cursor-default py-1 md:py-0"
                        >
                            <h3 className="font-bold text-base md:text-lg text-[#B8860B]" style={{ fontFamily: 'var(--font-arista)', letterSpacing: '-0.02em' }}>Get in Touch</h3>
                ...
                <div className="border-t border-gray-800 pt-4 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-2 md:gap-4 text-[10px] md:text-xs text-gray-500">
                    <p className="text-center md:text-left">© {new Date().getFullYear()} {companyName}. All rights reserved.</p>
