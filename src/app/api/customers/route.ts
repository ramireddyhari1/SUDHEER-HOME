...
// Cache customer data for 5 minutes - frequently updated
export const revalidate = CacheConfig.CUSTOMERS;
...
export async function GET(req: Request) {
    try {
        ...
        return createCachedResponse({ success: true, customers }, CacheConfig.CUSTOMERS, false);
    } catch (error) {
