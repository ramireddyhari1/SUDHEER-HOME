...
// Cache partners data for 5 minutes - admin only
export const revalidate = CacheConfig.PARTNERS;
...
export async function GET(request: NextRequest) {
    try {
        ...
        return createCachedResponse({ success: true, data: partners }, CacheConfig.PARTNERS, false);
    } catch (error: any) {
