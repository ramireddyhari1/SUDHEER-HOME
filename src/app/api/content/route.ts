...
// Cache content for 1 hour - update when PUT request is made
export const revalidate = CacheConfig.CONTENT;
...
export async function GET(req: Request) {
    try {
        ...
        return createCachedResponse({ success: true, content: contentMap }, CacheConfig.CONTENT);
    } catch (error) {
