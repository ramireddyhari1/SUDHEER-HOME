...
// Cache orders briefly - 1 minute since they're frequently updated
export const revalidate = CacheConfig.ORDERS;
...
export async function GET(req: Request) {
    try {
        ...
        return createCachedResponse({ success: true, orders }, CacheConfig.ORDERS, false);
    } catch (error) {
