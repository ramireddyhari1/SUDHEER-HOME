        ...
        <main className="min-h-screen relative overflow-hidden">
            ...
            <Container className="relative">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold text-[#2C1810] mb-6" style={{ fontFamily: 'var(--font-arista)', letterSpacing: '-0.02em' }}>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative bg-white/80 backdrop-blur-lg rounded-2xl p-8 border border-[#DAA520]/20 hover:border-[#DAA520]/40 transition-all duration-300 shadow-sm hover:shadow-xl">
                                    ...
                                    <h3 className="text-2xl font-bold text-[#2C1810] mb-3" style={{ fontFamily: 'var(--font-arista)' }}>{item.title}</h3>
            ...
            <Container className="relative z-10 mb-24">
                <div className="text-center mb-12">
                    <h2 className="text-4xl md:text-5xl font-bold text-[#2C1810] mb-4" style={{ fontFamily: 'var(--font-arista)' }}>How It Works</h2>
                    <p className="text-gray-600 text-lg">From order to delivery in just a few simple steps</p>
                </div>

                <div className="relative">
                    {/* Connecting Line */}
                    <div className="hidden md:block absolute top-8 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#DAA520] to-transparent" style={{ top: '32px' }} />
            ...
            <Container className="relative z-10 mb-24">
                <div className="text-center mb-14">
                    <h2 className="text-4xl md:text-5xl font-bold text-[#2C1810] mb-4" style={{ fontFamily: 'var(--font-arista)' }}>International Shipping Rates</h2>
                ...
                >
                    ...
                    <div className="relative z-10 p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="flex-1">
                            ...
                            <h3 className="text-3xl md:text-4xl font-bold text-white mb-3" style={{ fontFamily: 'var(--font-arista)' }}>India Shipping</h3>
            ...
            <Container className="relative z-10 text-center">
                ...
                >
                    <h2 className="text-4xl font-bold text-[#2C1810] mb-4" style={{ fontFamily: 'var(--font-arista)' }}>Ready to Order?</h2>
