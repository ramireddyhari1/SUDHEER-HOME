...
// Arista-Pro Local Font
const aristaPro = localFont({
  src: [
    {
      path: '../fonts/arista_pro/Arista-Pro-Light-trial.ttf',
      weight: '300',
      style: 'normal',
    },
    {
    ...
    {
      path: '../fonts/arista_pro/Arista-Pro-Bold-trial.ttf',
      weight: '600',
      style: 'normal',
    },
    {
    ...
    {
      path: '../fonts/arista_pro/Arista-Pro-Fat-trial.ttf',
      weight: '800',
      style: 'normal',
    },
  ],
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${poppins.variable} ${playfair.variable} ${aristaPro.variable} antialiased bg-background text-foreground font-sans`}
      >
        <AuthProvider>
          <CartProvider>
            <ClientLayoutWrapper>
