                                    ...
                                    <div className="mt-4 p-4 bg-[#FFFDF5] rounded-lg border border-[#DAA520]/30 animate-in fade-in zoom-in duration-300">
                                        <div className="flex flex-col items-center gap-4">
                                            ...
                                            <div className="grid grid-cols-2 gap-3 w-full mt-2">
                                                ...
                                                >
                                                    <div
                                                        className="flex items-center justify-center gap-2 text-white rounded-lg py-2 shadow-sm active:scale-95 transition-transform h-12 bg-[#5f259f]"
                                                    >
                                                        {/* PhonePe Logo Path */}
                                                ...
                                                >
                                                    <div
                                                        className="flex items-center justify-center gap-2 text-white rounded-lg py-2 shadow-sm active:scale-95 transition-transform h-12 bg-[#00baf2]"
                                                    >
                                                        ...
                                                        <svg className="h-8 w-auto px-4" viewBox="0 0 130 46" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
                                                            <g transform="matrix(0.35277777,0,0,-0.35277777,-10.926,61.159)">
                                                                <g transform="translate(376.586,173.169)">
                                                                    <path className="fill-[#27803b]" d="m 0,0 24.414,-48.553 -51.322,-48.54 z" />
                                                                </g>
                                                                <g transform="translate(359.472,173.169)">
                                                                    <path className="fill-[#e9661c]" d="m 0,0 24.396,-48.553 -51.343,-48.54 z" />
                                                                </g>
                                                                <g transform="translate(306.452,170.288)">
                                                                    <path className="fill-[#66686c]" d="m 0,0 c -1.337,1.843 -3.399,2.773 -6.2,2.773 h -106.036 l -5.252,-18.97 h 19.294 v 0.011 h 77.169 l -5.614,-20.272 h -77.171 l 0.007,0.042 h -19.286 l -16.007,-57.787 h 19.296 l 10.742,38.786 h 86.746 c 2.709,0 5.259,0.924 7.657,2.772 2.393,1.85 3.968,4.131 4.723,6.855 L 0.809,-6.996 C 1.593,-4.181 1.322,-1.845 0,0" />
                                                                </g>
                                                                <g transform="translate(156.12,82.541)">
                                                                    <path className="fill-[#66686c]" d="m 0,0 c -1.065,-3.835 -4.557,-6.488 -8.538,-6.488 h -99.491 c -2.711,0 -4.726,0.924 -6.051,2.77 -1.324,1.848 -1.608,4.134 -0.851,6.857 l 24.276,87.387 h 19.301 l -21.683,-78.05 h 77.206 l 21.683,78.05 h 19.297 z" />
                                                                </g>
                                                            </g>
                                                        </svg>
                                                    </div>
